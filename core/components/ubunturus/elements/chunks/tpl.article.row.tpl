<div class="blog-card">
  <div class="card shadow-soft border-soft p-0 p-md-4">
    <div class="card-header pb-2">
      <div class="post-meta">
        <div class="media d-block d-md-flex justify-content-between">
          <div><a href="profile.html" class="font-small font-weight-bold"><img class="avatar-sm img-fluid rounded-circle mr-2" src="../../assets/img/team/9.jpg" alt="avatar"> Zoltan Szogyenyi </a><span
              class="d-none d-md-inline font-small ml-1 font-weight-light">{$publishedon | dateago}</span></div>
    ...
    <div class="card-body py-3"><a href="single-article-right-sidebar.html"><img src="../../assets/img/pages/blog-article-1.jpg" class="card-img-top" alt="image"></a>
      ...
      <div class="mt-2 mt-lg-5"><a href="blog-right-sidebar.html#" class="badge badge-sm badge-secondary text-uppercase">Technology</a> <a href="blog-right-sidebar.html#" class="badge badge-sm badge-primary text-uppercase">Business</a> <a
          href="blog-right-sidebar.html#">
          {if $pagetitle ?}
          <h2 class="mt-3 mb-4">{$pagetitle}</h2>
          {/if}
        </a></div>
      <p class="card-text mb-0 mb-lg-4">All of the world's 10 largest companies as measured by market capitalization are American. Market capitalization is the total value of a company's entire purchased shares of stock. While these
        companies have their roots in the U.S. and are the embodiment of ...</p>
    </div>
